...
if __name__ == '__main__':
    ...
    parser.add_argument("-data_dir", type=str, default="/mnt/8tera/claudio.greco/guesswhat_lxmert/guesswhat/data/", help='Data Directory')
    ...
    print("dataset_args['max_no_qs']", dataset_args['max_no_qs'])
